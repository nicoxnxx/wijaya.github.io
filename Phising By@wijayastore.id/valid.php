...
<input type="number" class="input-anjir" name="playid" value="<?= $getUId ?>" autocomplete="off" required>
<input type="text" class="input-anjir" name="nick" value="<?= $nick ?>" autocomplete="off" required>
